...
public class StopWatch {
    ...
    public void setupUI() {
        ...
        rootContainer.getChildren().addAll(grid, digitalGrid, fillerGrid, dial, hand, controls);
    }
    ...
    private void updateDigital() {
        ...
        long catchUp = initialTime.getTimeInMillis() - madeTime.getTimeInMillis();        
        stopTime = Calendar.getInstance();
        startTime = Calendar.getInstance();
    ...
    public Double getHeight() {
        if (dialImage != null) {
            return dialImage.getHeight() + 50.0;
        }
        else return 0.0;
    }
